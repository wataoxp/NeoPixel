...
{
  /* USER CODE BEGIN 1 */
	uint8_t NeoPixelBuffer[NEOPIXEL_BUFFER_SIZE];		//Send NeoPixel24Bit Data
	uint16_t HueArray[NUM_LED] = {0};					//HueData(0~360)
	NeoPixelTypedef pixel[NUM_LED] = {0};				//Hue->RGB24bitData
	PatternTypedef Param = {
			.Lux = 4,		//LED Brightness
			.Type = 0,		//LED ColorPattern
			.Shift = 1,		//LED ShiftSpeed
	};
	//Type Color
	//0.Rainbow
	//1.RedtoYellow
